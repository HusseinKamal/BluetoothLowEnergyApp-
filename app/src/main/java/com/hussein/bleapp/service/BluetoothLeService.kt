package com.hussein.bleapp.service
...
class BluetoothLeService : Service() {
    ...
    companion object {
        const val ACTION_GATT_CONNECTED =
            "com.hussein.bleapp.ACTION_GATT_CONNECTED"
        const val ACTION_GATT_DISCONNECTED =
            "com.hussein.bleapp.ACTION_GATT_DISCONNECTED"

        const val ACTION_GATT_DISCOVERED =
            "com.hussein.bleapp.ACTION_GATT_DISCOVERED"

        const val ACTION_DATA_AVAILABLE =
            "com.hussein.bleapp.ACTION_GATT_AVAILABLE"

        const val EXTRA_DATA = "com.hussein.bleapp.EXTRA_DATA"

        //val UUID_HEART_RATE_MEASUREMENT: UUID = UUID.fromString(SampleGattAttributes.HEART_RATE_MEASUREMENT)
        //val UUID_HEART_RATE_MEASUREMENT: UUID = UUID.fromString("")
    ...
    fun setCharacteristicNotification(characteristic: BluetoothGattCharacteristic, enabled: Boolean) {
        PermissionUtil.checkBluetoothPermission(mContext = this)
